 ...
 checkpoints: []
  ...
  function normalizeLibrary(data) {
    ...
    data.prompts = data.prompts
      ...
      .map(({ tokenCount, tokenEncoding, tokenCountUpdatedAt, ...prompt }) => prompt);
    data.checkpoints = data.checkpoints
      .filter(c => checkpointCatIds.has(c.categoryId))
      .map(({ tokenCount, tokenEncoding, tokenCountUpdatedAt, ...checkpoint }) => checkpoint);
  }
